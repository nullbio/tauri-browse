...
<!-- Copy this block for each issue found. Interactive issues need step-by-step screenshots. Static issues (typos, visual glitches) only need a single screenshot. -->
